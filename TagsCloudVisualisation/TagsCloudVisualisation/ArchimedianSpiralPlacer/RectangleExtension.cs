...
namespace TagsCloudVisualisation.ArchimedianSpiralPlacer
{
    public static class RectangleExtension
    {
            ...
            List<Rectangle> placedRectangles)
        {
            ...
            while (true)
            {
                var potentionalRectanglesIntersectStatuses =
                    GetPotentionalRectanglesIntersectStatuses(rectangle, center);
        ...
        private static Dictionary<Rectangle, bool> GetPotentionalRectanglesIntersectStatuses(Rectangle rectangle,
            Point center)
        {
            ...
            return potentionalRectanglesIntersectStatuses;
        }
